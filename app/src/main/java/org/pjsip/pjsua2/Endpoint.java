...
public class Endpoint {
  ...
  public SWIGTYPE_p_void videoCodecGetParam(String codec_id) throws Exception {
    long cPtr = pjsua2JNI.Endpoint_videoCodecGetParam(swigCPtr, this, codec_id);
    return (cPtr == 0) ? null : new SWIGTYPE_p_void(cPtr, false);
  }

  public void videoCodecSetParam(String codec_id, SWIGTYPE_p_void param) throws Exception {
