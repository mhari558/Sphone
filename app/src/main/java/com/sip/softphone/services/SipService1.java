...
import com.sip.softphone.view.SipCall;
...
public class SipService1 extends BackgroundService {
    ...
    public void onCreate() {
        ...
        enqueueJob(new Runnable() {
            ...
            public void run() {
                ...
                loadNativeLibraries();
                mRingtoneUri = RingtoneManager.getActualDefaultRingtoneUri(SipService1.this, RingtoneManager.TYPE_RINGTONE);
                mAudioManager = (AudioManager) getSystemService(AUDIO_SERVICE);
                mVibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
                mBroadcastEmitter = new BroadcastEventTrigger(SipService1.this);
                endpointConfigure();
